...
import { lineas as linesData } from '@/app/lib/data'; // Importamos los datos de nuestro archivo local

export function InteractiveHero() {
  const [activeIndex, setActiveIndex] = useState(0);

  // Si aún no hay datos (poco probable con un archivo local, pero es buena práctica)
  if (!linesData || linesData.length === 0) {
    return <section className="h-screen w-full flex items-center justify-center bg-gray-100"><p>Cargando líneas...</p></section>;
  }
